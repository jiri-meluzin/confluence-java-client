...
/**
 * This class represents the body of a content object in the Confluence Cloud
 * server.
 */
...
public class ContentBody {
	...
	/**
	 * This constructor creates the content body using the value defined for a given
	 * type.
	 *
